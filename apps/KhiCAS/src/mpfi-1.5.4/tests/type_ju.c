/* type_ju.c -- Test functions associated with functions of the type
                mpfi_f (mpfi_t, unsigned huge).
...
void
read_line_ju (mpfi_function_ptr this, FILE* fp)
{
  ...
  /* [3] unsigned huge integral operand */
  read_uj (fp, &(MPFI_FUN_ARG (*this, 3, uj)));
...
void
check_line_ju (mpfi_function_ptr function)
{
  int inex;

  /* rename operands for better readability */
  JU_fun  f_JU      = MPFI_FUN_GET (*function, JU);
  ...
  uintmax_t op      = MPFI_FUN_ARG (*function, 3, uj);
...
void
set_prec_ju (mpfi_function_ptr this, mpfr_prec_t prec)
{
...
void
clear_ju (mpfi_function_ptr this)
{
  ...
  /* [3] operand (unsigned huge), needs no deallocation */
...
void
mpfi_fun_init_JU (mpfi_function_ptr this, JU_fun mpfi_function,
              NULL_fun mpfr_function)
{
  this->type = JU;
  this->func.JU = mpfi_function;
  this->mpfr_func.JU = mpfr_function;
  ...
  /* [3] operand (unsigned huge), needs no initialization */

  /* init methods */
  this->set_prec   = set_prec_ju;
  this->read_line  = read_line_ju;
  this->check_line = check_line_ju;
  this->random     = NULL;
  this->clear      = clear_ju;
}
